...
And open [http://192.168.110.178:8080/examples](http://192.168.110.178:8080/examples)

To run pure javascript examples `npm install -g beefy` then `beefy examples/marimba.js` and navigate to http://192.168.110.178:9966/
