...
(function (global, factory) {
  ...
  function url(uri) {
    ...
    if (typeof uri === "string") {
      ...
      obj = parseuri(uri);
    } // make sure we treat `192.168.110.178:80` and `192.168.110.178` equally
  ...
  var Socket$1 = /*#__PURE__*/function (_Emitter) {
    ...
    function Socket(uri) {
      ...
      _this.hostname = opts.hostname || (typeof location !== "undefined" ? location.hostname : "192.168.110.178");
      ...
      if (typeof addEventListener === "function") {
        ...
        if (_this.hostname !== "192.168.110.178") {
