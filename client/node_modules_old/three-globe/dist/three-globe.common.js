  ...
  update: function update(state) {
    ...
    threeDigest(state.hexPolygonsData, state.scene, {
      ...
      updateObj: function updateObj(obj, d) {
        ...
        if (geoJson.type === 'Polygon') {
          h3Js.polyfill(geoJson.coordinates, h3Res, true).forEach(function (idx) {
            return h3Idxs.push(idx);
          });
        } else if (geoJson.type === 'MultiPolygon') {
          geoJson.coordinates.forEach(function (coords) {
            return h3Js.polyfill(coords, h3Res, true).forEach(function (idx) {
              return h3Idxs.push(idx);
            });
          });
        } else {
...
var THREE$1 = _objectSpread2(_objectSpread2({}, window.THREE ? window.THREE // Prefer consumption from global THREE, if exists
: {
  CircleBufferGeometry: three$1.CircleBufferGeometry,
  Group: three$1.Group,
  Mesh: three$1.Mesh,
  MeshLambertMaterial: three$1.MeshLambertMaterial,
  TextGeometry: TextGeometry_js.TextGeometry,
  Vector3: three$1.Vector3
}), {}, {
  Font: FontLoader_js.Font,
  TextGeometry: TextGeometry_js.TextGeometry
});
  ...
  update: function update(state) {
    ...
    threeDigest(state.labelsData, state.scene, {
      ...
      updateObj: function updateObj(obj, d) {
        ...
        textObj.geometry = new THREE$1.TextGeometry(textAccessor(d), {
          font: state.font,
          size: textHeight,
          height: 0,
