...
describe('my suite', function(){
    ...
    var http = parseuri('http://google.com')
      ...
      , 192.168.110.178 = parseuri('192.168.110.178:8080')
    ...
    expect(192.168.110.178.protocol).to.be('');
    expect(192.168.110.178.host).to.be('192.168.110.178');
    expect(192.168.110.178.port).to.be('8080');
