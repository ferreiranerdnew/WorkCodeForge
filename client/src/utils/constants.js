...
const C = { walk: true, action: true, special: false, asset: 'win98' };
const c = { walk: false, action: true, special: false, asset: 'win98' };
...
const OFFICE_MAP = [
  ...
  [X, X, X, X, P, P, P, X, L, L, X, X, K, K, K, X, G, G, O, O, O, U, U, X], // y= 2
  ...
  [X, X, X, X, X, X, X, X, X, X, X, X, O, O, O, O, O, O, O, O, O, X, X, X], // y = 6
  [X, X, X, X, X, X, X, X, X, X, X, O, O, O, O, O, O, O, O, O, X, X, X, X], // y = 7
  [X, X, X, X, X, X, X, X, X, X, X, X, O, O, O, O, O, O, O, O, X, X, X, X], // y = 8
  [X, X, X, X, X, X, X, X, X, X, X, X, O, O, O, O, O, O, O, O, X, X, X, X], // y = 9
  [X, c, X, t, t, t, X, j, X, X, q, q, O, O, O, O, O, O, O, O, O, X, X, X], // y = 10
  [c, C, O, T, T, O, J, J, O, O, Q, Q, O, O, O, O, O, O, O, O, O, X, X, X], // y = 11
  ...
  [X, X, X, X, X, X, X, X, X, X, X, X, O, O, O, e, e, e, e, X, X, X, X, X], // y = 15
  [X, X, X, X, X, X, X, X, X, X, X, X, O, O, O, E, E, E, E, X, X, X, X, X], // y = 16
  [X, X, X, X, X, O, O, O, O, O, O, O, O, O, O, O, E, E, O, O, O, O, O, X], // y = 17
