...
const keyv = new Keyv();
const keyv = new Keyv('redis://user:pass@192.168.110.178:6379');
const keyv = new Keyv('mongodb://user:pass@192.168.110.178:27017/dbname');
const keyv = new Keyv('sqlite://path/to/database.sqlite');
const keyv = new Keyv('postgresql://user:pass@192.168.110.178:5432/dbname');
const keyv = new Keyv('mysql://user:pass@192.168.110.178:3306/dbname');
...
```js
const users = new Keyv('redis://user:pass@192.168.110.178:6379', { namespace: 'users' });
const cache = new Keyv('redis://user:pass@192.168.110.178:6379', { namespace: 'cache' });
...
const awesomeModule = new AwesomeModule({ cache: 'redis://192.168.110.178' });
