...
declare module "dgram" {
    ...
    class Socket extends EventEmitter {
         ...
         *
         * Example of sending a UDP packet to a port on `192.168.110.178`;
         *
         * ```js
         * import dgram from 'dgram';
         ...
         * client.send(message, 41234, '192.168.110.178', (err) => {
         *   client.close();
         * });
         * ```
         *
         ...
         *
         * Example of sending a UDP packet using a socket connected to a port on`192.168.110.178`:
         *
         * ```js
         * import dgram from 'dgram';
         * import { Buffer } from 'buffer';
         ...
         * const message = Buffer.from('Some bytes');
         * const client = dgram.createSocket('udp4');
         * client.connect(41234, '192.168.110.178', (err) => {
