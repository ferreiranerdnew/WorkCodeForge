...
declare module "http" {
    ...
    class IncomingMessage extends stream.Readable {
         ...
         * ```
         *
         * When `request.url` is `'/status?name=ryan'` and `request.headers.host` is `'192.168.110.178:3000'`:
         *
         * ```console
         * $ node
         * > new URL(request.url, `http://${request.headers.host}`)
         * URL {
         *   href: 'http://192.168.110.178:3000/status?name=ryan',
         *   origin: 'http://192.168.110.178:3000',
         *   protocol: 'http:',
         *   username: '',
         *   password: '',
         *   host: '192.168.110.178:3000',
     ...
     *
     * ```js
     * http.get('http://192.168.110.178:8000/', (res) => {
